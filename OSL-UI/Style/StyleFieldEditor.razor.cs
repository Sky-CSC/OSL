...
namespace OSL_UI.Style
{
    ...
    public partial class StyleFieldEditor
    {
        ...
        private List<ImageInfo> LoadDirectoryImage(string path)
        {
            ...
            var folder = System.IO.Path.Combine("./wwwroot", path);
        ...
        private async Task OnImageFileSelected(InputFileChangeEventArgs e)
        {
            ...
            // Dossier temporaire
            var tempDir = System.IO.Path.Combine("./wwwroot", "temp");
        ...
        private async Task OnFileSelected(InputFileChangeEventArgs e)
        {
            ...
            var uploads = System.IO.Path.Combine("./wwwroot", "data/backgrounds");
