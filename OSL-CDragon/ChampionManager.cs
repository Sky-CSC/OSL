...
namespace OSL_CDragon
{
    ...
    {
        private static Logger _logger = new ("ChampionManager");   
        /// <summary>
        ...
        public static void DownloadChampion(string numPatch, string region)
        {
            ...
            string championDirectory = CDragon.championDirectory;
            ...
            string champion = OSL_Common.Download.Download.DownloadStringAsync(urlChampion).Result;
            if (champion != null)
            {
                try
                {
        ...
        public static void ChampionAsyncDownload(int indexPatch, int indexRegion, string numPatch, string region, string championDirectory, string champID)
        {
            ...
            string championId = OSL_Common.Download.Download.DownloadStringAsync(urlChampionId).Result;
            if (championId != null)
            {
                ...
                OSL_Common.Download.Download.DownloadFileAsync(urlChampionPicture, squarePortrait);
                ...
                if (jsonChampionId.id != -1)
                {
                    ...
                    OSL_Common.Download.Download.DownloadFileAsync(urlChampionSoundChoose, championChoose);
                    ...
                    OSL_Common.Download.Download.DownloadFileAsync(urlChampionSoundBan, championBan);
                    ...
                    OSL_Common.Download.Download.DownloadFileAsync(urlChampionSoundSfx, championSfx);
                }
                ...
                if (jsonChampionId.skins.Count > 0)
                {
                    ...
                    OSL_Common.Download.Download.DownloadFileAsync(urlChampionSplashe, championSplashe);
                    ...
                    OSL_Common.Download.Download.DownloadFileAsync(urlChampionSplasheUncentered, championSplasheUncentered);
                    ...
                    OSL_Common.Download.Download.DownloadFileAsync(urlChampionTile, championTile);
                    ...
                    OSL_Common.Download.Download.DownloadFileAsync(urlChampionLoadScreen, championLoadScreen);
