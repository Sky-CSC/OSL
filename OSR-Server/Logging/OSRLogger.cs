...
namespace OSR_Server
{
    /// <summary>
    /// Logger
    /// </summary>
    public class OSRLogger
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OSRLogger"/> class.
        /// </summary>
        /// <param name="logLevel"></param>
        /// <param name="contextPrefix"></param>
        public OSRLogger(string contextPrefix = "", LoggingLevel? logLevel = null)
        {
