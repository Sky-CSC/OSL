...
namespace OSL_Web.Pages.EndGame
{
    ...
    {
        private static Logger _logger = new("EndGameView1Page");
        ...
        public string GetTimerDiv(double div)
        {
            try
            {
                double gameLength = DataProcessing.EndGame.jsonContentMatch.info.gameDuration;
        ...
        {
            Configuration.Overlay.EndGame.View1.Config.LoadFormatingDataConfig();
            ...
            EndGamePage.textValueOverlayView1.ValueStats = "TOTAL_DAMAGE_DEALT_TO_CHAMPIONS";
        }
