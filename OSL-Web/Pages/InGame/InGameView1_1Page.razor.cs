...
namespace OSL_Web.Pages.InGame
{
    public partial class InGameView1_1Page
    {
        ...
        public class FormatingData
        {
            ...
            //Color/anim/backround
            public string ColorBaronDragonBackgroundTimerFrame { get; set; }
            public string ColorOrderBackgroundItems { get; set; }
            //public string ColorOrderAnimationBackgroundItems { get; set; }
            //public string ColorOrderAnimationItems { get; set; }
            public string ColorOrderBackgroundScoreItems { get; set; }
            //public string ColorOrderAnimationBackgroundScoreItems { get; set; }
            public string ColorOrderAnimationBorderScoreItems { get; set; }
            public string ColorChaosBackgroundItems { get; set; }
            //public string ColorChaosAnimationBackgroundItems { get; set; }
            //public string ColorChaosAnimationItems { get; set; }
            public string ColorChaosBackgroundScoreItems { get; set; }
            //public string ColorChaosAnimationBackgroundScoreItems { get; set; }
            public string ColorChaosAnimationBorderScoreItems { get; set; }

            //Picture
            public string PictureOrderDragonBanner { get; set; }
            public string PictureChaosDragonBanner { get; set; }
            public string ElderDragonIcon { get; set; }
            public string HeraldIcon { get; set; }
            public string BaronIcon { get; set; }
            public string PositionOrderTop { get; set; }
            public string PositionChaosTop { get; set; }
            public string PositionOrderJungle { get; set; }
            public string PositionChaosJungle { get; set; }
            public string PositionOrderMid { get; set; }
            public string PositionChaosMid { get; set; }
            public string PositionOrderBottom { get; set; }
            public string PositionChaosBottom { get; set; }
            public string PositionOrderSupport { get; set; }
            public string PositionChaosSupport { get; set; }
            public string InhibIcon { get; set; }
            public string BaronBuffIcon { get; set; }
            public string ElderBuffIcon { get; set; }
        }
